...
#6. SUPP.FIG.2 / Creating integrated objects with ortholgueLists from other databases (Supplement Figure 2)
```{r}
...
##6.1 SUPP.FIG.4 / Clustering Silhouette Co-Efficient (Supplement Figure 4)
