...
##2.3 FIG.1B / Dimplots of clustering, sample overlap(original identifier), species overlap 
```{r}
outputFolder <- "/media/Helios_scStorage/Mariano/Human_Mice_Comparison/Human_Mice_Integrated"
...
##3.1 FIG.1C / Dimplot of cell types by species
```{r}
outputFolder <- "/media/Helios_scStorage/Mariano/Human_Mice_Comparison/Human_Mice_Integrated"
...
##4.1 FIG.1D / Barplot of % cells per cell type (condition)
...
##4.2 FIG.1E&F / Dotplot with marker genes, find marker with seurat
...
###5.3.2 FIG.5B / Mean +/- Sem bar graphs condition
...
###5.3.3 FIG.2A / Sankey diagramm for visualizing distribution of DEGs in biological contrasts 
...
###5.3.4 FIG.2B / DEGs Barplot per cell type 
```{r}
outputFolder <- "/media/Helios_scStorage/Mariano/Human_Mice_Comparison/Human_Mice_Integrated/Contrast_Cell_specific/"
...
###5.4.6 FIG.4 / GO (Database) GSEA results in Heatmap using simplifyEnrichment for HFrEF
```{r}
outputFolder <- "/media/Helios_scStorage/Mariano/Human_Mice_Comparison/Human_Mice_Integrated/Contrast_Cell_specific/GSEA_analysis"
...
###5.4.7 FIG.5A / building Dot plot with GSEA result Cardiomyocytes
```{r}
...
#### 5.4.7.1 SUPP.FIG.6A-D / GO (Database) GSEA results in Dot plot for HFrEF Endothelial
```{r}
outputFolder <- "/media/Helios_scStorage/Mariano/Human_Mice_Comparison/Human_Mice_Integrated/Contrast_Cell_specific/GSEA_analysis"
...
##5.5 SUPP.FIG.3 / Circos plot Human specific mice matched

###5.5.1 SUPP.FIG.3A / Circos plot contrast and cell type specific HFrEF Top 10 log2fC sorted DEGs for Human with mouse log2FC
...
###5.5.2 SUPP.FIG.3B / Circos plot contrast and cell type specific HFrEF Top 10 log2fC sorted DEGs for Mice with mouse log2FC
...
#6. SUPP.FIG.2 / Creating integrated objects with ortholgueLists from other databases
```{r}
...
##6.1 SUPP.FIG.4 / Clustering Silhouette Co-Efficient
...
#7. SUPP.FIG.5A&B / Build UpSet plot with DEG list
