...
##4.1 Barplot of % cells per cell type (condition)
...
###5.3.3 DEGs Barplot per cell type 
```{r}
outputFolder <- "/media/Helios_scStorage/Mariano/Human_Mice_Comparison/Human_Mice_Integrated/Contrast_Cell_specific/"
...
###5.4.6 GO (Database) GSEA results in Heatmap using simplifyEnrichment for HFrEF / building Dot plot Cardiomyocytes
```{r}
outputFolder <- "/media/Helios_scStorage/Mariano/Human_Mice_Comparison/Human_Mice_Integrated/Contrast_Cell_specific/GSEA_analysis"
...
#### 5.4.6.1 GO (Database) GSEA results in Dot plot for HFrEF Endothelial
```{r}
outputFolder <- "/media/Helios_scStorage/Mariano/Human_Mice_Comparison/Human_Mice_Integrated/Contrast_Cell_specific/GSEA_analysis"
...
```
###6.2.0 Build UpSet plot with DEG list
